...
main_loop:
    ...
    cpi r16, high(TIMER_VALUE)    ; Compara a parte alta do valor, se o resultado for zero aciona o flag (Z)
    brne main_loop
    cpi r17, low(TIMER_VALUE)     ; Subtrai a parte low do valor da parte low do timer e levanta uma flag
